...
from models.unimanual2bimanual.kit_mocap_reconstruction_module import *
from models.unimanual2bimanual.kit_mocap_forecasting_module import *
...
class model(nn.Module):
    ...
    def forward(self, data, mode):
        ...
        if hasattr(self,"forecast_pred_input"):
            if self.forecast_pred_input == 1:
                data["inp_xyz"]     = reconstruction_module_out["pred_free_net_inp_xyz"]
                data["inp_obj_xyz"] = reconstruction_module_out["pred_inp_obj_xyz"]
